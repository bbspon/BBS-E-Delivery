...
const OrderDetailPage = () => {
  ...
  return (
   <>
    <Header/>
     <div className="container py-4 " style={{ maxWidth: '800px', margin: '0 auto', padding: '20px'  }}>
      ...
      <div className="row g-4">
        ...
        <div className="col-md-6">
          <div className="card p-3 h-100 shadow-sm">
            ...
            <p><strong>Payment:</strong> ₹{order.totalAmount} via {order.paymentMethod}</p>
      ...
      <div className="card mt-4 p-3 shadow-sm">
        ...
        <form onSubmit={handleOTPSubmit} className="row g-2 mt-3">
          ...
          <div className="col-md-3">
            <button className="btn btn-warning w-100" type="submit">Submit OTP</button>
          </div>
          <div className="col-md-3">
            <button className="btn btn-success w-100" type="button" onClick={handleMarkDelivered}>Mark as Delivered</button>
          </div>
        </form>
      </div>
      ...
      <div className="card mt-4 p-3 shadow-sm">
        ...
        <a href={`tel:${order.customerPhone}`} className="btn btn-outline-primary me-2 mb-2">Call</a>
        <a href={`sms:${order.customerPhone}`} className="btn btn-outline-secondary me-2 mb-2">SMS</a>
        <a href={`https://wa.me/${order.customerPhone}`} target="_blank" rel="noopener noreferrer" className="btn btn-outline-success mb-2">WhatsApp</a>
         </div>
      </div>
    </div>
   </>
